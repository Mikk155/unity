...
public:
	...
	bool IsPlayer() override { return true; } // Spectators should return false for this, they aren't "players" as far as game logic is concerned, No. return true, check if is observer instead. -Mikk
